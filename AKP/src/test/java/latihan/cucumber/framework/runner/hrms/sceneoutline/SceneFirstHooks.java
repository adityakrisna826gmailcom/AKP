...
import latihan.cucumber.framework.scenariotest.hrms.HRMSSceneLogin;
...
public class SceneFirstHooks {
	...
	private HRMSSceneLogin[] tests = HRMSSceneLogin.values();
	@Before
	public void setUp() {
	...
	public void getResultStatus(Scenario scenario) throws IOException {
		if(scenario.isFailed()) {
			String screenshotPath = Utils.getScreenshot(driver, "HRMS_SceneFirstHooks_Outline"+scenario.getName().replace(" ", "_"));
