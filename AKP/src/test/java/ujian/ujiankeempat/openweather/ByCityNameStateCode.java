...
public class ByCityNameStateCode {
	...
	public void befTest()
	{
		...
		req = new JSONObject();
		String excelPath = "./Data/ByCityNameStateCode.xlsx";
//		String excelPath = "C:\\Users\\NEXSOFT\\Documents\\Bootcamp\\AKP\\UJIAN_KEEMPAT\\RESTASSURED\\DataDriven\\ByCityNameStateCode.xlsx";
	...
	public Object[] dataDrivenGet()
	{
		...
		while(r.hasNext())
		{
			...
			for(int kolom=0;kolom<intColumnNums;kolom++)
			{
				...
				if (kolom == 0) {
					System.out.println("City Name : " + dDriven[baris][kolom]);
				}else {
					System.out.println("State Code : " + dDriven[baris][kolom]);
				}
			}
			System.out.println("=========================");
			baris++;
	...
	public void testGet(String name, String stateCode)
	{
