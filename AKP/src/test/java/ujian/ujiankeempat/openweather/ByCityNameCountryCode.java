...
public class ByCityNameCountryCode {
	...
	public void befTest()
	{
		...
		req = new JSONObject();
		String excelPath = "./Data/ByCityNameCountryCode.xlsx";
//		String excelPath = "C:\\Users\\NEXSOFT\\Documents\\Bootcamp\\AKP\\UJIAN_KEEMPAT\\RESTASSURED\\DataDriven\\ByCityNameCountryCode.xlsx";
	...
	public void testGet(String name, String countryCoude)
	{
		System.out.println();
		System.out.println("==================================");
