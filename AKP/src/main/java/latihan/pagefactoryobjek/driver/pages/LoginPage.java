package latihan.pagefactoryobjek.driver.pages;
...
public class LoginPage {
	...
	//Page Factory
		...
		@FindBy(xpath = "//p[@class='//span[@class='oxd-text oxd-text--span oxd-input-field-error-message oxd-input-group__message']")
